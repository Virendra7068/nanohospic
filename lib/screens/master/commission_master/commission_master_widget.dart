...
class AreaScreen extends StatelessWidget {
  final List<CommissionMasterModel> areaCategories = [
    CommissionMasterModel(id: 1, categoryName: "Country", icon: Icons.flag),
  ];
...
class ItemMasterScreen extends StatelessWidget {
  final List<CommissionMasterModel> itemMasterCategories = [
    CommissionMasterModel(id: 1, categoryName: "Items", icon: Icons.inventory),
    CommissionMasterModel(
      id: 2,
      categoryName: "Items Category",
      icon: Icons.category,
    ),
    CommissionMasterModel(id: 2, categoryName: "Unit", icon: Icons.category),
    CommissionMasterModel(id: 5, categoryName: "Company", icon: Icons.business),
    CommissionMasterModel(
      id: 4,
      categoryName: "Division",
      icon: Icons.account_tree,
    ),
    CommissionMasterModel(id: 3, categoryName: "HSN", icon: Icons.list_alt),
