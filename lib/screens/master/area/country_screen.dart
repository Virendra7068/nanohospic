...
import 'package:nanohospic/screens/master/area/state_screen.dart';
import 'dart:convert';
...
class _CountryScreenState extends State<CountryScreen> {
  ...
  void _showDeleteConfirmationDialog(CountryEntity country) {
    showDialog(
      context: context,
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          final success = await _deleteCountry(country.id!);
                              ...
                              SnackBar(
                                content: Row(
                                  children: [
                                    ...
                                    SizedBox(width: 8),
                                    Text('Country "${country.name}" deleted'),
                                  ],
                                ),
                                backgroundColor: Colors.green,
                                behavior: SnackBarBehavior.floating,
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Container(
                      ...
                      child: Icon(Icons.flag, color: Colors.blue.shade600),
                    ),
                      ...
                      child: ElevatedButton(
                        onPressed: isSubmitting
                            ...
                            : () async {
                                ...
                                await _addCountry(countryNameController.text);
                                  ...
                                  SnackBar(
                                    content: Row(
                                      children: [
                                        ...
                                        SizedBox(width: 8),
                                        Text(
                                          '${countryNameController.text} added successfully!',
                                        ),
                                      ],
                                    ),
                                    backgroundColor: Colors.green,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'Manage all your countries in one place',
                          style: TextStyle(
                            fontSize: 14,
  ...
  Widget _buildBody() {
    final displayCountries = _isSearching ? _filteredCountries : _countries;
  ...
  Widget _buildCountryItem(CountryEntity country, int index) {
    return Container(
      ...
      child:
          Material(
                ...
                child: InkWell(
                  onTap: () {
                    print(
                      'Navigating to states for country: ${country.name}, '
                      'Server ID: ${country.serverId}, '
                      'Local ID: ${country.id}',
                    );

                    // ✅ FIXED: सही country ID निकालें
                    final int actualCountryId;

                    if (country.serverId != null && country.serverId! > 0) {
                      // पहले serverId use करें
                      actualCountryId = country.serverId!;
                    } else if (country.id != null && country.id! > 0) {
                      // फिर localId use करें
                      actualCountryId = country.id!;
                    } else {
                      // दोनों नहीं हैं तो 0 use करें
                      actualCountryId = 0;
                    }

                    print(
                      'Using Country ID: $actualCountryId for ${country.name}',
                    );
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            StateScreen(country: countryModel),
                      ),
                    );
                  },
                  onLongPress: () {
                    _showDeleteConfirmationDialog(country);
                  },
                  borderRadius: BorderRadius.circular(16),
                              ...
                              if (country.createdAt != null) ...[
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 6),
                                    Text(
                                      'Created: ${_formatDate(country.createdAt!)}',
                                      style: TextStyle(
                                        fontSize: 11,
                                        color: Colors.grey.shade600,
                                      ),
