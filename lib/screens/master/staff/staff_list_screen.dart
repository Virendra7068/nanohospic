...
import 'package:nanohospic/screens/master/staff/add_staff_screen.dart'; // Import new screen
...
class _StaffListScreenState extends State<StaffListScreen> {
  ...
  void didChangeDependencies() {
    ...
    // Listen for staff updates when returning from add screen
...
''';
  ...
  Future<void> _loadSyncStats() async {
    try {
      _totalRecords = await _staffRepository.getTotalCount();
      _syncedRecords = await _staffRepository.getSyncedCount();
      _pendingRecords = await _staffRepository.getPendingCount();
      setState(() {});
    } catch (e) {
  ...
  Future<void> _loadFilterOptions() async {
    try {
      _departments = await _staffRepository.getAllDepartments();
      _designations = await _staffRepository.getAllDesignations();
      setState(() {});
    } catch (e) {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'Manage all your staff members in one place',
                          style: TextStyle(
                            fontSize: 14,
