...
class StaffCardModel {
  ...
  factory StaffCardModel.fromJson(Map<String, dynamic> json) {
    return StaffCardModel(
      id: json['id'],
...
class _StaffWidgetState extends State<StaffWidget> {
  List<StaffCardModel> categories = [
    StaffCardModel(id: 1, categoryName: "Staff", icon: Icons.inventory_2),
    StaffCardModel(id: 12, categoryName: "Department", icon: Icons.list_alt),
    StaffCardModel(id: 2, categoryName: "Designation", icon: Icons.design_services),
  ];

  bool _isSearching = false;
  final TextEditingController _searchController = TextEditingController();
  List<StaffCardModel> _filteredCategories = [];
  ...
  Widget _buildCategoryCard(StaffCardModel category, int index) {
    return Material(
      color: Colors.white,
...
class AreaScreen extends StatelessWidget {
  final List<StaffCardModel> areaCategories = [
    StaffCardModel(id: 1, categoryName: "Country", icon: Icons.flag),
  ];
...
class ItemMasterScreen extends StatelessWidget {
  final List<StaffCardModel> itemMasterCategories = [
    StaffCardModel(id: 1, categoryName: "Items", icon: Icons.inventory),
    StaffCardModel(id: 2, categoryName: "Items Category", icon: Icons.category),
    StaffCardModel(id: 2, categoryName: "Unit", icon: Icons.category),
    StaffCardModel(id: 5, categoryName: "Company", icon: Icons.business),
    StaffCardModel(id: 4, categoryName: "Division", icon: Icons.account_tree),
    StaffCardModel(id: 3, categoryName: "HSN", icon: Icons.list_alt),
