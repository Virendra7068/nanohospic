...
import 'package:nanohospic/screens/master/test_master/group_list_screen.dart';
import 'package:nanohospic/screens/master/test_master/instrument_master_screen.dart';
import 'package:nanohospic/screens/master/test_master/packages_list_screen.dart';
import 'package:nanohospic/screens/master/test_master/test_bom_screen.dart';
import 'package:nanohospic/screens/master/test_master/test_list_screeen.dart';
import 'package:nanohospic/screens/master/test_master/test_method_master_screen.dart';
import 'package:responsive_sizer/responsive_sizer.dart';
import 'package:flutter_animate/flutter_animate.dart';

class TestMasterWidgetModel {
  final int id;
  final String categoryName;
  final IconData icon;

  TestMasterWidgetModel({
    required this.id,
    required this.categoryName,
    required this.icon,
  });

  factory TestMasterWidgetModel.fromJson(Map<String, dynamic> json) {
    return TestMasterWidgetModel(
      id: json['id'],
...
class TestMasterWidget extends StatefulWidget {
  const TestMasterWidget({super.key});

  @override
  State<TestMasterWidget> createState() => _TestMasterWidgetState();
}

class _TestMasterWidgetState extends State<TestMasterWidget> {
  List<TestMasterWidgetModel> categories = [
    TestMasterWidgetModel(
      id: 1,
      categoryName: "Group",
      icon: Icons.inventory_2,
    ),
    TestMasterWidgetModel(id: 2, categoryName: "Test", icon: Icons.list_alt),
    TestMasterWidgetModel(
      id: 3,
    ...
    TestMasterWidgetModel(
      id: 4,
      categoryName: "Test BOM",
      icon: Icons.design_services,
    ),
    TestMasterWidgetModel(
      id: 5,
      categoryName: "Instrument Master",
      icon: Icons.design_services,
    ),
    TestMasterWidgetModel(
      id: 6,
      categoryName: "Test Method Master",
      icon: Icons.design_services,
    ),
  ];
  ...
  List<TestMasterWidgetModel> _filteredCategories = [];
  ...
  Widget _buildCategoryCard(TestMasterWidgetModel category, int index) {
    return Material(
      color: Colors.white,
...
//   final List<TestMasterWidgetModel> areaCategories = [
//     TestMasterWidgetModel(id: 1, categoryName: "Country", icon: Icons.flag),
//   ];
...
//   final List<TestMasterWidgetModel> itemMasterCategories = [
//     TestMasterWidgetModel(id: 1, categoryName: "Items", icon: Icons.inventory),
//     TestMasterWidgetModel(id: 2, categoryName: "Items Category", icon: Icons.category),
//     TestMasterWidgetModel(id: 2, categoryName: "Unit", icon: Icons.category),
//     TestMasterWidgetModel(id: 5, categoryName: "Company", icon: Icons.business),
//     TestMasterWidgetModel(id: 4, categoryName: "Division", icon: Icons.account_tree),
//     TestMasterWidgetModel(id: 3, categoryName: "HSN", icon: Icons.list_alt),
